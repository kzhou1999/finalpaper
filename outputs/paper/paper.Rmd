...
# Data
\
The research uses R language[@rstudio] as its foundation. I have used packages such as tidyverse[@tidy], here[@here] and readr[@readr] to prepare data for this project. I then used knitr[@knitr] to generate table and ggplot2[@ggplot2] to generate plots.
\
